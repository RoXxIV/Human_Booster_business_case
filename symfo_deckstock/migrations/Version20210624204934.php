 ...
 */
final class Version20210624204934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, model_id INT NOT NULL, skateshop_id INT NOT NULL, released_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', description VARCHAR(500) NOT NULL, width VARCHAR(10) NOT NULL, length VARCHAR(10) NOT NULL, shape VARCHAR(10) NOT NULL, concave VARCHAR(10) NOT NULL, price INT NOT NULL, picture_path VARCHAR(255) DEFAULT NULL, INDEX IDX_54F1F40B7975B7E7 (model_id), INDEX IDX_54F1F40B80EFCCFC (skateshop_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
