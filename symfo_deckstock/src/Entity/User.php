...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    {
        $this->skateshop = new ArrayCollection();
    }
     ...
     */
    public function getSkateshop(): Collection
    {
    ...
    {
        if (!$this->skateshop->contains($skateshop)) {
    ...
    {
        if ($this->skateshop->removeElement($skateshop)) {
